...
const SeeElectricityTransactions = () => {
    ...
    return (
        <div className='mt-20'>
            ...
            <h2 className='mx-auto max-w-screen-xl px-4 lg:px-12 text-2xl mb-4 font-bold'>Here is your electricity transaction Details</h2>
                    ...
                    <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                            <div className="w-50 ml-auto md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                               <Link to='/add_electricity_transaction'> <button type="button" className=" flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
...
export default SeeElectricityTransactions